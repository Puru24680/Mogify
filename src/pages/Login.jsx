...
export default function Login() {
  ...
  const [form, setForm] = useState({ email: profile.email ?? "", password: "" });
  ...
  return (
    <div className="min-h-screen px-4 py-6 sm:px-6 lg:px-8">
      <div className="mx-auto grid min-h-[calc(100vh-3rem)] max-w-7xl overflow-hidden rounded-[36px] border border-slate-200/70 bg-white/80 shadow-[0_24px_100px_rgba(15,23,42,0.1)] backdrop-blur-xl lg:grid-cols-[0.95fr_1.05fr]">
        <motion.div
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="mt-5 max-w-md text-base leading-7 text-white/70">
              Return to your premium AI appearance coaching workspace and keep building a sharper, more intentional visual profile.
            </p>
          </div>
          ...
          <div className="relative space-y-6">
            <div className="rounded-[28px] border border-white/10 bg-white/6 p-6 backdrop-blur-xl">
              ...
              <p className="mt-4 text-3xl font-semibold tracking-tight">Sign in and continue your coaching loop.</p>
            </div>

            <div className="rounded-[28px] border border-white/10 bg-white/6 p-6 backdrop-blur-xl">
              <div className="flex items-center gap-3 text-sm text-white/70">
                <Sparkles className="h-4 w-4 text-violet-300" />
                Progress-driven layout
              </div>
              <p className="mt-4 text-base leading-7 text-white/75">
                Your analyses, profile settings, and saved history live inside a polished dashboard built for a real SaaS product.
              </p>
            </div>
          </div>
        </motion.div>
        ...
        >
          <form className="w-full max-w-md" onSubmit={handleSubmit}>
            <div className="mb-8">
              <p className="text-sm font-semibold uppercase tracking-[0.24em] text-indigo-600">Login</p>
              <h1 className="mt-3 text-4xl font-semibold tracking-tight text-slate-900">Sign in to your workspace</h1>
              <p className="mt-4 text-sm leading-6 text-slate-600">
                Access your dashboard, upload new images, and review your appearance coaching history.
              </p>
            </div>
